var app = new Vue({
    ...
    methods: {
        ...
        unparseWebsocketMessage: function(message){
            ...
            var color = "#";
            color += parseInt(wsObject.light.color.split(",")[0]).toString(16);
            color += parseInt(wsObject.light.color.split(",")[1]).toString(16);
            color += parseInt(wsObject.light.color.split(",")[2]).toString(16);
